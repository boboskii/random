...
export interface WhitelistRolesInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "INDEFINITE_WHITELISTER_ROLE_DESCRIPTION" | "WHITELIST_EXPIRATION_EXTENDER_ROLE_DESCRIPTION" | "WHITELIST_EXPIRATION_SETTER_ROLE_DESCRIPTION"): FunctionFragment;
...
export interface WhitelistRoles extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: WhitelistRolesInterface;
...
//# sourceMappingURL=WhitelistRoles.d.ts.map