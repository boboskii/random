...
export interface MockAuthorizerAlwaysFalseV0Interface extends utils.Interface {
    functions: {
        "isAuthorizedV0(bytes32,address,bytes32,address,address)": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "isAuthorizedV0"): FunctionFragment;
...
export interface MockAuthorizerAlwaysFalseV0 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: MockAuthorizerAlwaysFalseV0Interface;
...
//# sourceMappingURL=MockAuthorizerAlwaysFalseV0.d.ts.map