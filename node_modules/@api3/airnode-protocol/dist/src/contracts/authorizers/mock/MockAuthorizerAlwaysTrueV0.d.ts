...
export interface MockAuthorizerAlwaysTrueV0Interface extends utils.Interface {
    functions: {
...
export interface MockAuthorizerAlwaysTrueV0 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: MockAuthorizerAlwaysTrueV0Interface;
...
//# sourceMappingURL=MockAuthorizerAlwaysTrueV0.d.ts.map