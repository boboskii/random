...
export interface IAirnodeRrpV0 extends BaseContract {
    ...
    functions: {
        ...
        requesterToRequestCountPlusOne(requester: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            requestCountPlusOne: BigNumber;
        }>;
        setSponsorshipStatus(requester: string, sponsorshipStatus: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        sponsorToRequesterToSponsorshipStatus(sponsor: string, requester: string, overrides?: CallOverrides): Promise<[boolean] & {
            sponsorshipStatus: boolean;
        }>;
        sponsorToWithdrawalRequestCount(sponsor: string, overrides?: CallOverrides): Promise<[BigNumber] & {
            withdrawalRequestCount: BigNumber;
        }>;
        templates(templateId: BytesLike, overrides?: CallOverrides): Promise<[
            string,
            string,
            string
        ] & {
    ...
    estimateGas: {
        ...
        sponsorToRequesterToSponsorshipStatus(sponsor: string, requester: string, overrides?: CallOverrides): Promise<BigNumber>;
        sponsorToWithdrawalRequestCount(sponsor: string, overrides?: CallOverrides): Promise<BigNumber>;
        templates(templateId: BytesLike, overrides?: CallOverrides): Promise<BigNumber>;
    };
    populateTransaction: {
        ...
        requesterToRequestCountPlusOne(requester: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        setSponsorshipStatus(requester: string, sponsorshipStatus: boolean, overrides?: Overrides & {
            from?: string;
        }): Promise<PopulatedTransaction>;
        sponsorToRequesterToSponsorshipStatus(sponsor: string, requester: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        sponsorToWithdrawalRequestCount(sponsor: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        templates(templateId: BytesLike, overrides?: CallOverrides): Promise<PopulatedTransaction>;
    };
}
//# sourceMappingURL=IAirnodeRrpV0.d.ts.map