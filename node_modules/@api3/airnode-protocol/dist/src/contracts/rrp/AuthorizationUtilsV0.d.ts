...
export interface AuthorizationUtilsV0Interface extends utils.Interface {
    functions: {
...
export interface AuthorizationUtilsV0 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AuthorizationUtilsV0Interface;
...
//# sourceMappingURL=AuthorizationUtilsV0.d.ts.map