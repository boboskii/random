...
export interface IRrpBeaconServerV0Interface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "INDEFINITE_WHITELISTER_ROLE_DESCRIPTION" | "WHITELIST_EXPIRATION_EXTENDER_ROLE_DESCRIPTION" | "WHITELIST_EXPIRATION_SETTER_ROLE_DESCRIPTION" | "accessControlRegistry" | "adminRole" | "adminRoleDescription" | "beaconIdToReaderToSetterToIndefiniteWhitelistStatus" | "beaconIdToReaderToWhitelistStatus" | "deriveBeaconId" | "extendWhitelistExpiration" | "fulfill" | "indefiniteWhitelisterRole" | "manager" | "readBeacon" | "readerCanReadBeacon" | "requestBeaconUpdate" | "revokeIndefiniteWhitelistStatus" | "setIndefiniteWhitelistStatus" | "setUpdatePermissionStatus" | "setWhitelistExpiration" | "sponsorToUpdateRequesterToPermissionStatus" | "whitelistExpirationExtenderRole" | "whitelistExpirationSetterRole"): FunctionFragment;
...
export interface IRrpBeaconServerV0 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IRrpBeaconServerV0Interface;
    ...
    functions: {
        ...
        requestBeaconUpdate(beaconId: BytesLike, requester: string, designatedWallet: string, parameters: BytesLike, overrides?: Overrides & {
            from?: string;
        }): Promise<ContractTransaction>;
        ...
        sponsorToUpdateRequesterToPermissionStatus(sponsor: string, updateRequester: string, overrides?: CallOverrides): Promise<[boolean] & {
    ...
    callStatic: {
        ...
        readerCanReadBeacon(beaconId: BytesLike, reader: string, overrides?: CallOverrides): Promise<boolean>;
        requestBeaconUpdate(beaconId: BytesLike, requester: string, designatedWallet: string, parameters: BytesLike, overrides?: CallOverrides): Promise<void>;
    ...
    estimateGas: {
        ...
        sponsorToUpdateRequesterToPermissionStatus(sponsor: string, updateRequester: string, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        sponsorToUpdateRequesterToPermissionStatus(sponsor: string, updateRequester: string, overrides?: CallOverrides): Promise<PopulatedTransaction>;
...
//# sourceMappingURL=IRrpBeaconServerV0.d.ts.map