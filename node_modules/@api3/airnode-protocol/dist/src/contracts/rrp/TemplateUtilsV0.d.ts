...
export interface TemplateUtilsV0Interface extends utils.Interface {
    functions: {
...
export interface TemplateUtilsV0 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: TemplateUtilsV0Interface;
...
//# sourceMappingURL=TemplateUtilsV0.d.ts.map