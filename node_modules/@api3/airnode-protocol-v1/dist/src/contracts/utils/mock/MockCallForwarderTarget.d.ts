...
export interface MockCallForwarderTargetInterface extends utils.Interface {
    ...
    encodeFunctionData(functionFragment: "nonpayableTargetFunction", values: [PromiseOrValue<string>, PromiseOrValue<BigNumberish>]): string;
    encodeFunctionData(functionFragment: "payableTargetFunction", values: [
...
export interface MockCallForwarderTarget extends BaseContract {
    ...
    functions: {
        nonpayableTargetFunction(input1: PromiseOrValue<string>, input2: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
        payableTargetFunction(input1: PromiseOrValue<string>, input2: PromiseOrValue<BigNumberish>, msgValue: PromiseOrValue<BigNumberish>, overrides?: PayableOverrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    storage2(overrides?: CallOverrides): Promise<BigNumber>;
    callStatic: {
        nonpayableTargetFunction(input1: PromiseOrValue<string>, input2: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string, boolean] & {
            output1: string;
            output2: boolean;
        }>;
        payableTargetFunction(input1: PromiseOrValue<string>, input2: PromiseOrValue<BigNumberish>, msgValue: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[string, boolean] & {
            output1: string;
            output2: boolean;
        }>;
        storage1(overrides?: CallOverrides): Promise<string>;
