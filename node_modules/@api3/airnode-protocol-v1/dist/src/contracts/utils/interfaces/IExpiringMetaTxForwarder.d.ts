...
export interface IExpiringMetaTxForwarderInterface extends utils.Interface {
    functions: {
...
export interface IExpiringMetaTxForwarder extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IExpiringMetaTxForwarderInterface;
