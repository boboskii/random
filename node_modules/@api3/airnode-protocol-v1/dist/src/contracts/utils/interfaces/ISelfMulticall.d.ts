...
export interface ISelfMulticallInterface extends utils.Interface {
    functions: {
        "multicall(bytes[])": FunctionFragment;
        "tryMulticall(bytes[])": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "multicall" | "tryMulticall"): FunctionFragment;
...
export interface ISelfMulticall extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: ISelfMulticallInterface;
