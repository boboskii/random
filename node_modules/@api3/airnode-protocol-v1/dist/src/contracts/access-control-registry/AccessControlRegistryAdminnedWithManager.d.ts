...
export interface AccessControlRegistryAdminnedWithManagerInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "accessControlRegistry" | "adminRole" | "adminRoleDescription" | "manager" | "multicall" | "tryMulticall"): FunctionFragment;
