...
export interface IAccessControlRegistryInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: "cancel" | "execute" | "getRoleAdmin" | "grantRole" | "hasRole" | "initializeManager" | "initializeRoleAndGrantToSender" | "metaTxWithHashIsExecutedOrCanceled" | "multicall" | "renounceRole" | "revokeRole" | "tryMulticall"): FunctionFragment;
...
export interface IAccessControlRegistry extends BaseContract {
    ...
    functions: {
        ...
        metaTxWithHashIsExecutedOrCanceled(metaTxHash: PromiseOrValue<BytesLike>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<ContractTransaction>;
    ...
    callStatic: {
        ...
        metaTxWithHashIsExecutedOrCanceled(metaTxHash: PromiseOrValue<BytesLike>, overrides?: CallOverrides): Promise<boolean>;
