...
export interface IAccessControlRegistryAdminnedInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "accessControlRegistry" | "adminRoleDescription" | "multicall" | "tryMulticall"): FunctionFragment;
...
export interface IAccessControlRegistryAdminned extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IAccessControlRegistryAdminnedInterface;
