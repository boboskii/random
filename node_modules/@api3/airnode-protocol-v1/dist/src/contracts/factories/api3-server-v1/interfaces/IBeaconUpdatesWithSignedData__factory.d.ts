...
import type { IBeaconUpdatesWithSignedData, IBeaconUpdatesWithSignedDataInterface } from "../../../api3-server-v1/interfaces/IBeaconUpdatesWithSignedData";
export declare class IBeaconUpdatesWithSignedData__factory {
    ...
    static createInterface(): IBeaconUpdatesWithSignedDataInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): IBeaconUpdatesWithSignedData;
}
