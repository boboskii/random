...
import type { IApi3ServerV1, IApi3ServerV1Interface } from "../../../api3-server-v1/interfaces/IApi3ServerV1";
export declare class IApi3ServerV1__factory {
    ...
    static createInterface(): IApi3ServerV1Interface;
    static connect(address: string, signerOrProvider: Signer | Provider): IApi3ServerV1;
}
