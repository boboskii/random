...
var IDapiServer__factory = /** @class */ (function () {
    function IDapiServer__factory() {
    }
    IDapiServer__factory.createInterface = function () {
        return new ethers_1.utils.Interface(_abi);
    };
    IDapiServer__factory.connect = function (address, signerOrProvider) {
        return new ethers_1.Contract(address, _abi, signerOrProvider);
    };
    IDapiServer__factory.abi = _abi;
    return IDapiServer__factory;
}());
