...
import type { IRequesterAuthorizer, IRequesterAuthorizerInterface } from "../../../authorizers/interfaces/IRequesterAuthorizer";
export declare class IRequesterAuthorizer__factory {
    ...
    static createInterface(): IRequesterAuthorizerInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): IRequesterAuthorizer;
}
