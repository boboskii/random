...
import type { IAllocatorWithManager, IAllocatorWithManagerInterface } from "../../../allocators/interfaces/IAllocatorWithManager";
export declare class IAllocatorWithManager__factory {
    static readonly abi: readonly [{
        ...
        readonly name: "hasSlotSetterRoleOrIsManager";
        readonly outputs: readonly [{
    ...
    static createInterface(): IAllocatorWithManagerInterface;
    static connect(address: string, signerOrProvider: Signer | Provider): IAllocatorWithManager;
}
