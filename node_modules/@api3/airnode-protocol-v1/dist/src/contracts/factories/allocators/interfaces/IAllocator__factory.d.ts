...
import type { IAllocator, IAllocatorInterface } from "../../../allocators/interfaces/IAllocator";
export declare class IAllocator__factory {
    ...
    static connect(address: string, signerOrProvider: Signer | Provider): IAllocator;
}
