...
export interface AllocatorWithAirnodeInterface extends utils.Interface {
    functions: {
        ...
        "deriveSlotSetterRole(address)": FunctionFragment;
        "hasSlotSetterRoleOrIsAirnode(address,address)": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "SLOT_SETTER_ROLE_DESCRIPTION" | "accessControlRegistry" | "adminRoleDescription" | "airnodeToSlotIndexToSlot" | "deriveAdminRole" | "deriveSlotSetterRole" | "hasSlotSetterRoleOrIsAirnode" | "isTrustedForwarder" | "multicall" | "resetSlot" | "setSlot" | "slotCanBeResetByAccount" | "tryMulticall"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "deriveSlotSetterRole", values: [PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "hasSlotSetterRoleOrIsAirnode", values: [PromiseOrValue<string>, PromiseOrValue<string>]): string;
    ...
    decodeFunctionResult(functionFragment: "deriveSlotSetterRole", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "hasSlotSetterRoleOrIsAirnode", data: BytesLike): Result;
...
export interface AllocatorWithAirnode extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AllocatorWithAirnodeInterface;
    ...
    functions: {
        ...
        airnodeToSlotIndexToSlot(arg0: PromiseOrValue<string>, arg1: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<[
            string,
            string,
            number
        ] & {
        ...
        deriveSlotSetterRole(airnode: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[string] & {
            slotSetterRole: string;
        }>;
        hasSlotSetterRoleOrIsAirnode(airnode: PromiseOrValue<string>, account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean]>;
    ...
    estimateGas: {
        ...
        airnodeToSlotIndexToSlot(arg0: PromiseOrValue<string>, arg1: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<BigNumber>;
        deriveAdminRole(airnode: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        deriveSlotSetterRole(airnode: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        hasSlotSetterRoleOrIsAirnode(airnode: PromiseOrValue<string>, account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        airnodeToSlotIndexToSlot(arg0: PromiseOrValue<string>, arg1: PromiseOrValue<BigNumberish>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        deriveAdminRole(airnode: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        deriveSlotSetterRole(airnode: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        hasSlotSetterRoleOrIsAirnode(airnode: PromiseOrValue<string>, account: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
