...
export interface RequesterAuthorizerWithAirnodeInterface extends utils.Interface {
    functions: {
        ...
        "deriveAdminRole(address)": FunctionFragment;
        "deriveAuthorizationExpirationExtenderRole(address)": FunctionFragment;
        "deriveAuthorizationExpirationSetterRole(address)": FunctionFragment;
        "deriveIndefiniteAuthorizerRole(address)": FunctionFragment;
    ...
    getFunction(nameOrSignatureOrTopic: "AUTHORIZATION_EXPIRATION_EXTENDER_ROLE_DESCRIPTION" | "AUTHORIZATION_EXPIRATION_SETTER_ROLE_DESCRIPTION" | "INDEFINITE_AUTHORIZER_ROLE_DESCRIPTION" | "accessControlRegistry" | "adminRoleDescription" | "airnodeToRequesterToAuthorizationStatus" | "airnodeToRequesterToSetterToIndefiniteAuthorizationStatus" | "deriveAdminRole" | "deriveAuthorizationExpirationExtenderRole" | "deriveAuthorizationExpirationSetterRole" | "deriveIndefiniteAuthorizerRole" | "extendAuthorizerExpiration" | "isAuthorized" | "isTrustedForwarder" | "multicall" | "revokeIndefiniteAuthorizationStatus" | "setAuthorizationExpiration" | "setIndefiniteAuthorizationStatus" | "tryMulticall"): FunctionFragment;
    ...
    encodeFunctionData(functionFragment: "deriveAdminRole", values: [PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "deriveAuthorizationExpirationExtenderRole", values: [PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "deriveAuthorizationExpirationSetterRole", values: [PromiseOrValue<string>]): string;
    encodeFunctionData(functionFragment: "deriveIndefiniteAuthorizerRole", values: [PromiseOrValue<string>]): string;
    ...
    decodeFunctionResult(functionFragment: "deriveAdminRole", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "deriveAuthorizationExpirationExtenderRole", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "deriveAuthorizationExpirationSetterRole", data: BytesLike): Result;
    decodeFunctionResult(functionFragment: "deriveIndefiniteAuthorizerRole", data: BytesLike): Result;
...
export interface RequesterAuthorizerWithAirnode extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: RequesterAuthorizerWithAirnodeInterface;
    ...
    functions: {
        ...
        airnodeToRequesterToAuthorizationStatus(arg0: PromiseOrValue<string>, arg1: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[
            number,
            BigNumber
        ] & {
            expirationTimestamp: number;
        ...
        airnodeToRequesterToSetterToIndefiniteAuthorizationStatus(arg0: PromiseOrValue<string>, arg1: PromiseOrValue<string>, arg2: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean]>;
        deriveAdminRole(airnode: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[string] & {
            adminRole: string;
        }>;
        deriveAuthorizationExpirationExtenderRole(airnode: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[string] & {
            authorizationExpirationExtenderRole: string;
        }>;
        deriveAuthorizationExpirationSetterRole(airnode: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[string] & {
            authorizationExpirationSetterRole: string;
        }>;
        deriveIndefiniteAuthorizerRole(airnode: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[string] & {
            indefiniteAuthorizerRole: string;
        }>;
    ...
    estimateGas: {
        ...
        airnodeToRequesterToAuthorizationStatus(arg0: PromiseOrValue<string>, arg1: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        airnodeToRequesterToSetterToIndefiniteAuthorizationStatus(arg0: PromiseOrValue<string>, arg1: PromiseOrValue<string>, arg2: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        deriveAdminRole(airnode: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        deriveAuthorizationExpirationExtenderRole(airnode: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        deriveAuthorizationExpirationSetterRole(airnode: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        deriveIndefiniteAuthorizerRole(airnode: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        extendAuthorizerExpiration(airnode: PromiseOrValue<string>, requester: PromiseOrValue<string>, expirationTimestamp: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
        }): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        airnodeToRequesterToAuthorizationStatus(arg0: PromiseOrValue<string>, arg1: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        airnodeToRequesterToSetterToIndefiniteAuthorizationStatus(arg0: PromiseOrValue<string>, arg1: PromiseOrValue<string>, arg2: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        deriveAdminRole(airnode: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        deriveAuthorizationExpirationExtenderRole(airnode: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        deriveAuthorizationExpirationSetterRole(airnode: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        deriveIndefiniteAuthorizerRole(airnode: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        extendAuthorizerExpiration(airnode: PromiseOrValue<string>, requester: PromiseOrValue<string>, expirationTimestamp: PromiseOrValue<BigNumberish>, overrides?: Overrides & {
            from?: PromiseOrValue<string>;
