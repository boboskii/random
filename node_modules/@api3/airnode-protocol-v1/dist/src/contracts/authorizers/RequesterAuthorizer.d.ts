...
export interface RequesterAuthorizerInterface extends utils.Interface {
    functions: {
...
export interface RequesterAuthorizer extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: RequesterAuthorizerInterface;
