...
export interface IRequesterAuthorizerWithErc721Interface extends utils.Interface {
    functions: {
...
export interface IRequesterAuthorizerWithErc721 extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IRequesterAuthorizerWithErc721Interface;
    ...
    functions: {
        ...
        airnodeToChainIdToRequesterToBlockStatus(airnode: PromiseOrValue<string>, chainId: PromiseOrValue<BigNumberish>, requester: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean] & {
            isBlocked: boolean;
        }>;
        airnodeToChainIdToRequesterToTokenAddressToTokenDeposits(airnode: PromiseOrValue<string>, chainId: PromiseOrValue<BigNumberish>, requester: PromiseOrValue<string>, token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[BigNumber] & {
            tokenDepositCount: BigNumber;
        }>;
        ...
        airnodeToDepositorToFreezeStatus(airnode: PromiseOrValue<string>, depositor: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[boolean] & {
            isFrozen: boolean;
        }>;
        airnodeToWithdrawalLeadTime(airnode: PromiseOrValue<string>, overrides?: CallOverrides): Promise<[number] & {
            withdrawalLeadTime: number;
        }>;
    ...
    estimateGas: {
        ...
        airnodeToChainIdToRequesterToBlockStatus(airnode: PromiseOrValue<string>, chainId: PromiseOrValue<BigNumberish>, requester: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        airnodeToChainIdToRequesterToTokenAddressToTokenDeposits(airnode: PromiseOrValue<string>, chainId: PromiseOrValue<BigNumberish>, requester: PromiseOrValue<string>, token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        ...
        airnodeToDepositorToFreezeStatus(airnode: PromiseOrValue<string>, depositor: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
        airnodeToWithdrawalLeadTime(airnode: PromiseOrValue<string>, overrides?: CallOverrides): Promise<BigNumber>;
    ...
    populateTransaction: {
        ...
        airnodeToChainIdToRequesterToBlockStatus(airnode: PromiseOrValue<string>, chainId: PromiseOrValue<BigNumberish>, requester: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        airnodeToChainIdToRequesterToTokenAddressToTokenDeposits(airnode: PromiseOrValue<string>, chainId: PromiseOrValue<BigNumberish>, requester: PromiseOrValue<string>, token: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        ...
        airnodeToDepositorToFreezeStatus(airnode: PromiseOrValue<string>, depositor: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
        airnodeToWithdrawalLeadTime(airnode: PromiseOrValue<string>, overrides?: CallOverrides): Promise<PopulatedTransaction>;
