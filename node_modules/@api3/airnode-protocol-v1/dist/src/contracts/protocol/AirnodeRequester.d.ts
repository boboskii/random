...
export interface AirnodeRequesterInterface extends utils.Interface {
    functions: {
...
export interface AirnodeRequester extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: AirnodeRequesterInterface;
