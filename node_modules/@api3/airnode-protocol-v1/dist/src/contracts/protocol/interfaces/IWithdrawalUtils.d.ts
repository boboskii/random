...
export interface IWithdrawalUtilsInterface extends utils.Interface {
    functions: {
...
export interface IWithdrawalUtils extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IWithdrawalUtilsInterface;
