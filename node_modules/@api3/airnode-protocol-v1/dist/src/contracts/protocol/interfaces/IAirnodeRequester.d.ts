...
export interface IAirnodeRequesterInterface extends utils.Interface {
    functions: {
        "airnodeProtocol()": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "airnodeProtocol"): FunctionFragment;
...
export interface IAirnodeRequester extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IAirnodeRequesterInterface;
