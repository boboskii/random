...
export interface IBeaconUpdatesWithSignedDataInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "containsBytecode" | "getBalance" | "getBlockBasefee" | "getBlockNumber" | "getBlockTimestamp" | "getChainId" | "multicall" | "tryMulticall" | "updateBeaconSetWithBeacons" | "updateBeaconWithSignedData"): FunctionFragment;
...
export interface IBeaconUpdatesWithSignedData extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IBeaconUpdatesWithSignedDataInterface;
