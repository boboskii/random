...
export interface BeaconSetUpdatesWithPspInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "HUNDRED_PERCENT" | "conditionPspBeaconSetUpdate" | "containsBytecode" | "fulfillPspBeaconSetUpdate" | "getBalance" | "getBlockBasefee" | "getBlockNumber" | "getBlockTimestamp" | "getChainId" | "multicall" | "tryMulticall" | "updateBeaconSetWithBeacons"): FunctionFragment;
...
export interface BeaconSetUpdatesWithPsp extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: BeaconSetUpdatesWithPspInterface;
