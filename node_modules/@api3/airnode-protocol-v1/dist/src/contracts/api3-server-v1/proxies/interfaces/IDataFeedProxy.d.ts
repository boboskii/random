...
export interface IDataFeedProxyInterface extends utils.Interface {
    functions: {
        "api3ServerV1()": FunctionFragment;
        "dataFeedId()": FunctionFragment;
        "read()": FunctionFragment;
    };
    getFunction(nameOrSignatureOrTopic: "api3ServerV1" | "dataFeedId" | "read"): FunctionFragment;
...
export interface IDataFeedProxy extends BaseContract {
    connect(signerOrProvider: Signer | Provider | string): this;
    attach(addressOrName: string): this;
    deployed(): Promise<this>;
    interface: IDataFeedProxyInterface;
