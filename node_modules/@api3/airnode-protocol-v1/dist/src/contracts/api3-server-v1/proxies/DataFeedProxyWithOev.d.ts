...
export interface DataFeedProxyWithOevInterface extends utils.Interface {
    functions: {
    ...
    getFunction(nameOrSignatureOrTopic: "api3ServerV1" | "dataFeedId" | "oevBeneficiary" | "read"): FunctionFragment;
